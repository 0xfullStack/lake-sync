...
ALTER TABLE "ReserveLog" ADD CONSTRAINT "fk_protocol_factory_address" FOREIGN KEY ("factory_address") REFERENCES "Protocol" ("factory_address");

CREATE INDEX "index_block_number" ON "Pair" ("block_number");
CREATE INDEX "index_factory_address" ON "Pair" ("factory_address");
CREATE UNIQUE INDEX "index_pair_address" ON "Pair" ("pair_address");

CREATE INDEX "index_block_number" ON "ReserveLog" ("block_number");
CREATE INDEX "index_factory_address" ON "ReserveLog" ("factory_address");
CREATE UNIQUE INDEX "index_pair_address" ON "ReserveLog" ("pair_address");
